...
selector.CanSelect = function (browser) {
...
selector.addEventListener = function(browser,name,func,user)
{
...
selector.removeEventListener = function(browser,name,func,user)
{
...
selector.start = function(browser) {
